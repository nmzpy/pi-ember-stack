...
import { type LFile, loadFileKindAndText } from "./file-kind.ts";
import { resolveTarget } from "./fs-write.ts";
import type { HashStore } from "./hash-store.ts";
import { lineHashes } from "./hashline/index.ts";
import { toCwd } from "./paths.ts";
import { detectEnding, type LineEnding, stripBOM, toLF } from "./replace-diff.ts";
import { abortIf, visLines } from "./utils.ts";
import { valAccess, valKind } from "./validation.ts";
