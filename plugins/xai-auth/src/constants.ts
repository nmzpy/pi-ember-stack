...
export const XAI_PROVIDER_NAME = "xAI (OAuth)";
export const XAI_OAUTH_NAME = "xAI (Grok)";
export const XAI_API_IDENTIFIER = "xai-responses";
export const DEFAULT_XAI_MODEL = "grok-4.5";
export const DEFAULT_XAI_IMAGE_MODEL = "grok-imagine-image-quality";

export const XAI_CURSOR_TOOL_NAMES = [
	"Read",
	"Write",
	"StrReplace",
	"Edit",
