...
function writeStderrDiagnostic(payload) {
  try {
...
h2Stream.on("response", (headers) => {
  ...
  if (status && status !== "200") {
    writeStderrDiagnostic({ kind: "http_status", status, headers: { ...headers } });
  }
});
